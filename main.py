...
class MainApp(App):
    def build(self):
        ...
        for row in buttons:
            h_layout=BoxLayout()
            for label in row:
                button = Button(text=label, font_size=30, background_color="grey",pos_hint={'center_x':0.5, 'center_y':0.5})
    ...
    def on_button_press(self, instance):
        ...
        if button_text == "C":
            ...
            if current and (self.last_was_operator and button_text in self.operator):
               return
